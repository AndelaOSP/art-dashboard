  ...
  render() {
    return (
      <div className="modal-container">
        <div className="page-indicator specs-component">
          <div
            className={this.props.page === 0 ? 'circle shade-1' : 'circle no-shade'}
            onKeyDown={() => {}}
            role="presentation"
          >1
          </div>
          ...
          <div className="line" />
          <div className={this.props.page === 0 ? 'circle no-shade' : 'circle shade-1'}>2</div>
